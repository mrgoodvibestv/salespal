          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full rounded-xl border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700 focus:outline-none focus:border-[#4B6BF5] focus:ring-1 focus:ring-[#4B6BF5]/20 transition-colors"
              >
