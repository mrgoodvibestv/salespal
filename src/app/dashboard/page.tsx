            ...
            {campaignList.map((c) => {
              ...
              return (
                <Link
                  ...
                  className="flex items-center justify-between gap-4 px-5 py-4 rounded-2xl border border-gray-200 hover:border-[#4B6BF5]/40 hover:bg-blue-50/20 transition-all group"
                >
                  <div className="flex items-center gap-4 min-w-0">
                    <div className="size-9 rounded-xl flex items-center justify-center shrink-0" style={{ background: "linear-gradient(135deg, #EEF1FE, #F0EBFE)" }}>
                  ...
                  <div className="flex items-center gap-4 shrink-0">
                    ...
                    <svg className="size-4 text-gray-300 group-hover:text-[#4B6BF5] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center">
      <div className="size-16 rounded-2xl flex items-center justify-center mb-5" style={{ background: "linear-gradient(135deg, #EEF1FE, #F0EBFE)" }}>
      ...
      <p className="text-sm text-gray-500 max-w-xs leading-relaxed mb-6">
        Start your first campaign to find qualified leads and generate personalized outreach sequences.
      </p>
      <div className="mt-2 px-5 py-4 rounded-xl border border-gray-100 bg-gray-50 max-w-sm text-left">
...
function SignOutButton() {
  return (
    <form action="/auth/signout" method="post">
      <button type="submit" className="text-sm text-gray-400 hover:text-black transition-colors">
        Sign out
      </button>
    </form>
  )
