  ...
  return (
    <div className="flex min-h-screen bg-white overflow-x-hidden">
      ...
      <main className="flex-1 min-w-0 ml-0 md:ml-64">
        <div className="w-full max-w-7xl mx-auto px-6 md:px-8 pt-[88px] md:pt-8 pb-8 space-y-6 sm:space-y-8">
        ...
        {(() => {
          ...
          if (!ad) return null
          return (
            <div className="flex flex-col md:flex-row gap-6 p-5 rounded-2xl bg-gray-50 border border-gray-100 shadow-sm text-sm">
              {/* Left column — Target Companies + Target Titles */}
              <div className="md:w-1/3 space-y-4">
                ...
                {ad.target_companies && ad.target_titles?.length ? (
              ...
              {ad.pitch_summary && (
                <div className="md:w-2/3 space-y-1">
                  ...
                  <p className="text-gray-700 leading-relaxed">{ad.pitch_summary}</p>
                </div>
              )}
            </div>
          )
